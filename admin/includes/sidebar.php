            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <!-- <li><i class="menu-icon ti-email"></i><a href="add-vehicle.php">Add Vehicle </a></li> -->
                            <li><i class="menu-icon fa fa-th"></i><a href="manage-incomingvehicle.php">Park/Booked Vehicle</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="manage-outgoingvehicle.php">Checked Out Vehicle</a>
                        </li>
                   ...
                   <!-- <li class="menu-item-has-children dropdown">
                    ...
                    <li>
                        <a href="reg-users.php"> <i class="menu-icon ti-user"></i>Manage Users </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
