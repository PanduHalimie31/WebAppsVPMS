...
if (strlen($_SESSION['vpmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "update tblcategory set VehicleCat='$catname' Price='$prates' where ID='$eid'");
        if ($query) {
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    while ($row = mysqli_fetch_array($ret)) { ?>
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Hourly
                                                    Rates</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="rates" name="rates"
                                                    class="form-control" placeholder="IDR per Hours" required="true"
                                                    value="<?php echo $row['Price']; ?>"></div>
                                        </div>
