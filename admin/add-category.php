...
if(isset($_POST['submit']))
  {
    ...
    $prates=$_POST['rates'];
    $query=mysqli_query($con, "insert into  tblcategory(VehicleCat,Price) value('$catname','$prates')");
    if ($query) {
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="rates" name="rates" class="form-control" placeholder="IDR per Hours" required="true"></div>
                                    </div>
