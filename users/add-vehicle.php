                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="add-vehicle.php">Booking</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="rates" name="rates" class="form-control" placeholder="IDR per Hours" required="true" readonly></div>
                                    </div>
                                    <script>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="ownername" name="ownername" class="form-control" required="true" value="<?php  echo $row['FirstName'];?>" readonly></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Contact Number</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="ownercontno" name="ownercontno" class="form-control" required="true" value="<?php  echo $row['MobileNumber'];?>" readonly ></div>
                                    </div>
                                    <!-- -->
                                    <?php } ?>
                                   <p style="text-align: center;"> <button type="submit" class="btn btn-primary btn-sm" name="submit" >BOOK</button></p>
                                </form>
                            </div>
                        </div>
                    </div>
