                ...
                <div class="login-form">
                    <form method="post" onsubmit="return checkpass();">
                        <div class="form-group">
                            <label>First and Mid Name</label>
                           <input type="text" name="firstname" placeholder="Ex: Budi Darma" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Last Name</label>
                           <input type="text" name="lastname" placeholder="Ex: Dartono" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Mobile Number</label>
                           <input type="text" name="mobilenumber" maxlength="12" pattern="[0-9]{10,12}" placeholder="Ex: 123412341234" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Email address</label>
                           <input type="email" name="email" placeholder="Ex: budidarmad123@mail.com" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="repeatpassword" placeholder="Repeat Password" required="true" class="form-control">
                        </div>
                        <div class="checkbox">
