                ...
                <div class="login-form">
                    <form method="post">
                        <div class="form-group">
                            <label>E-mail or Contact Number</label>
                           <input type="text" name="emailcont" required="true" placeholder="example@mail.co.id/123456781234" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="password" placeholder="********" required="true" class="form-control">
                        </div>
                        <div class="checkbox">
                       ...
                       <div class="checkbox" style="padding-bottom: 20px;padding-top: 20px;">
                            <label class="pull-left" >
                                <a href="signup.php">New Account? Register Here!</a>
                            </label>
                        </div>
                        <div class="checkbox" style="padding-bottom: 20px;padding-top: 20px;">
                            <label class="pull-right" >
